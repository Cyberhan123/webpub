            ...
            <div className={style['home-wraper']}>
                ...
                <section className={style.integration}>
                    ...
                    <div className={style['integration-text']}>
                        <h1>集成</h1>
                        <h5>将常用的运维指令集成为运维工具<p>轻松实现一键执行</p>可自行扩充脚本<p></p></h5>
                    </div>
                    <div className={style['intergration-show']}>
                ...
                <section className={style.watch}>
                    <div className={style['watch-text']}>
                        <h1>监控</h1>
                        <h5>将常用轻松监控服务器各项性能指标<p>可视化使得管理更简单</p></h5>
                    </div>
                    <div className={style['watch-show']}>
